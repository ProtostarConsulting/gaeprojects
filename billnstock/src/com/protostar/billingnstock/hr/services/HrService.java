...
public class HrService {
	...
	public HRSettingsEntity getHRSettingsByBiz(@Named("id") Long busId) {
		...
		HRSettingsEntity filteredSettings = ofy().load().type(HRSettingsEntity.class)
	...
	public List<String> getSalaryHeadNames() {
		...
		for (int i = 0; i < HREntityUtil.getStandardMonthlySalaryStructureRules().size(); i++) {
			String salHeadNames = HREntityUtil.getStandardMonthlySalaryStructureRules().get(i).getHeadName();
	...
	public List<String> getDeductionHeadNames() {
		...
		for (int i = 0; i < HREntityUtil.getStandardMonthlySalaryDeductionRules().size(); i++) {
			String headName = HREntityUtil.getStandardMonthlySalaryDeductionRules().get(i).getHeadName();
