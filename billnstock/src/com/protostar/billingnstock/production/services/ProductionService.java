...
public class ProductionService {
	...
	public ProductionShipmentEntity getProdShipmentByID(
		...
		ProductionShipmentEntity foundProdReceipt = ofy()
				...
				.key(Key.create(Key.create(BusinessEntity.class, busId),
						ProductionShipmentEntity.class, prShipId)).now();
		System.out.println("foundProdReceipt-----------"
	...
	public ProductionRequisitionEntity addRequisition(
			ProductionRequisitionEntity requisitionEntity) {
	...
	public ProductionShipmentEntity addProductionShipmentEntity(
		...
		return stockManagementService
				.addProductionShipmentEntity(documentEntity);
	}
	...
	public List<StockShipmentAgainstProductionRequisition> listStockIssue(@Named("busId") Long busId) {
		...
		List<StockShipmentAgainstProductionRequisition> stockIssueList = ofy().load().type(StockShipmentAgainstProductionRequisition.class)
				.ancestor(Key.create(BusinessEntity.class, busId)).list();
	...
	public ProductionPlanEntity addProdPlanEntity(
			ProductionPlanEntity prodPlanEntity) {
		ofy().save().entity(prodPlanEntity).now();
		return prodPlanEntity;
	}

	@ApiMethod(name = "getProductionPlanList", path = "getProductionPlanList")
	public List<ProductionPlanEntity> getProductionPlanList(
			@Named("busId") Long busId) {
		List<ProductionPlanEntity> planList = ofy().load()
				.type(ProductionPlanEntity.class)
				.ancestor(Key.create(BusinessEntity.class, busId)).list();
	...
	public BomEntity listBomEntityByID(@Named("busId") Long busId,
			@Named("id") Long bomId) {
	...
	public ProductionMachineEntity addProductionMachine(
			ProductionMachineEntity machine) {
		ofy().save().entity(machine).now();
		return machine;
	}

	@ApiMethod(name = "getMachineList", path = "getMachineList")
	public List<ProductionMachineEntity> getProductionMachineList(
			@Named("busId") Long busId) {
	...
	public List<QCMachineDailyRecordEntity> getQCMachineRecordList(
			@Named("busId") Long busId) {
		List<QCMachineDailyRecordEntity> qcMachineRecordList = ofy().load()
				.type(QCMachineDailyRecordEntity.class)
				.ancestor(Key.create(BusinessEntity.class, busId)).list();
	...
	public QCMachineDailyRecordEntity getQCMachineRecordById(
		...
		QCMachineDailyRecordEntity foundMachine = list.size() > 0 ? list.get(0)
				: null;
		return foundMachine;
	}

	@ApiMethod(name = "addQCMachineUnitMeasure", path = "addQCMachineUnitMeasure")
	public MachineQCUnitMeasure addQCMachineUnitMeasure(
			MachineQCUnitMeasure qcMachineUnit) {
	...
	public List<MachineQCUnitMeasure> getMachineQCUnitsMeasureList(
			@Named("busId") Long busId) {
	...
	public ProductionSetting getProductionSettingsByBiz(
			@Named("busId") Long busId) {
	...
	public List<ProductionRequisitionEntity> listProductionRequisitionEntity(
			@Named("busId") Long busId) {

		List<ProductionRequisitionEntity> productionRequisitionEntityList = ofy()
				.load().type(ProductionRequisitionEntity.class)
				.ancestor(Key.create(BusinessEntity.class, busId)).list();
	...
	public ProductionRequisitionEntity productionRequisitionEntityByItemNo(
			@Named("busId") Long busId, @Named("itemNo") int itemNumber) {

		System.out.println("item No...." + itemNumber);
		List<ProductionRequisitionEntity> list = ofy().load()
				.type(ProductionRequisitionEntity.class)
				.ancestor(Key.create(BusinessEntity.class, busId))
		...
		System.out.println("--------productionRequisitionEntity--------"+productionRequisitionEntity.getId());
		return productionRequisitionEntity;
	}

	@ApiMethod(name = "getRequisitionEntityByID", path = "getRequisitionEntityByID")
	public ProductionRequisitionEntity getRequisitionEntityByID(
			@Named("busId") Long busId, @Named("proId") Long proId) {
