	...
	// --------------------------------------------------//
		public void getProfitAndLossAcc(List<TypeInfo> list,
			...
			try {
				...
				List<PurchaseVoucherEntity> purchaseVoucherList = vs
						.listVoucherPurches(bid);
				
				List<PaymentVoucherEntity> PaymentVoucherList = vs
						.listVoucherPayment(bid);
				List<ReceiptVoucherEntity> receiptVoucherList = vs
						.listVoucherReciept(bid);
