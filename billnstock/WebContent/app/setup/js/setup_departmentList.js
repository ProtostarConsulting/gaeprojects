angular
		...
		.controller(
				...
				function($scope, $window, $mdToast, $timeout, $mdSidenav,
					...
					$scope.Parentdepartment=["HR","Support","Technical","Admin","Production","Office"];
					...
					$scope.saveDepartment=function(){
						...
						getsetupService.saveDepartment($scope.department2).then(function() {
							$scope.showAddToast();
						});
					}
					$scope.dept=function(){$scope.newDept=true;}
					$scope.back=function(){	$scope.getDepartmentList();
